...
if st.session_state.step == "welcome":
    ...
    st.markdown("<style>.stButton>button{height:50px!important;padding:2px 6px!important;min-width:36px!important}.stButton>button p{font-size:12px!important;text-align:center!important}div[data-testid=\"column\"]{min-width:0!important;overflow:visible!important}div[data-testid=\"column\"] p{font-size:12px!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}@media(max-width:640px){.main .block-container{max-width:100%!important;padding:8px!important}div[data-testid=\"stHorizontalBlock\"]{gap:2px!important}div[data-testid=\"column\"]{padding:0!important}.stButton>button{height:32px!important;min-width:24px!important;padding:0!important}.stButton>button p{font-size:10px!important;line-height:1!important}div[data-testid=\"column\"] p{font-size:10px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}}</style>", unsafe_allow_html=True)
