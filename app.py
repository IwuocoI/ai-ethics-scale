...
if st.session_state.step == "welcome":
    ...
    st.markdown("<style>.stButton>button{height:320px!important;padding:30px 10px!important}.stButton>button p{font-size:14px!important;line-height:1.4!important;text-align:center!important;white-space:pre-wrap!important}.stButton>button{max-width:170px!important;margin:0 auto!important}@media(max-width:640px){div[data-testid=\"stHorizontalBlock\"]{gap:2px!important}div[data-testid=\"column\"]{min-width:0!important;padding:0!important}.stButton>button{height:200px!important;max-width:120px!important;padding:10px 4px!important}.stButton>button p{font-size:10px!important}}</style>", unsafe_allow_html=True)
    s = st.session_state
    ...
    st.markdown("<style>.stButton>button{height:50px!important;padding:2px 6px!important;min-width:36px!important}.stButton>button p{font-size:12px!important;text-align:center!important}div[data-testid=\"column\"]{min-width:0!important;overflow:visible!important}div[data-testid=\"column\"] p{font-size:12px!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}@media(max-width:640px){div[data-testid=\"stHorizontalBlock\"]{width:100%!important;flex-wrap:nowrap!important;gap:0!important}div[data-testid=\"column\"]{padding:0!important;min-width:0!important}.stButton>button{height:32px!important;min-width:20px!important;padding:0 2px!important;font-size:10px!important}.stButton>button p{font-size:10px!important}div[data-testid=\"column\"] p{font-size:10px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}}</style>", unsafe_allow_html=True)
