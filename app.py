...
if st.session_state.step == "welcome":
    ...
    st.markdown("<style>.stButton>button{height:320px!important;padding:30px 10px!important}.stButton>button p{font-size:14px!important;line-height:1.4!important;text-align:center!important;white-space:pre-wrap!important}.stButton>button{max-width:300px!important;margin:0 auto!important}@media(max-width:640px){.main .block-container{max-width:100vw!important;padding:8px!important;overflow-x:hidden!important}div[data-testid='stHorizontalBlock']{flex-wrap:nowrap!important;gap:0!important;overflow-x:hidden!important}div[data-testid='column']{min-width:0!important;flex:1!important;padding:0!important}div[data-testid='column']>div{padding:0!important}.stButton>button{max-width:150px!important;width:100%!important;height:240px!important;padding:14px 4px!important;margin-left:auto!important;margin-right:auto!important}.stButton>button p{font-size:11px!important}}</style>", unsafe_allow_html=True)
    s = st.session_state
