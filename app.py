...
if st.session_state.step == "welcome":
    ...
    st.markdown("<style>.stButton>button{height:320px!important;padding:30px 10px!important}.stButton>button p{font-size:14px!important;line-height:1.4!important;text-align:center!important;white-space:pre-wrap!important}.stButton>button{max-width:170px!important;margin:0 auto!important}@media(max-width:640px){.main .block-container{max-width:100vw!important;padding:8px!important}div[data-testid=\"stHorizontalBlock\"]{flex-wrap:nowrap!important;overflow-x:auto!important;gap:2px!important}div[data-testid=\"column\"]{flex:0 0 auto!important;min-width:0!important;padding:0!important}.stButton>button{height:150px!important;width:44vw!important;max-width:44vw!important;padding:6px 4px!important}.stButton>button p{font-size:10px!important;line-height:1.2!important}}</style>", unsafe_allow_html=True)
    s = st.session_state
    ...
    st.markdown("<style>.stButton>button{height:50px!important;padding:2px 6px!important;min-width:36px!important}.stButton>button p{font-size:12px!important;text-align:center!important}div[data-testid=\"column\"]{min-width:0!important;overflow:visible!important}div[data-testid=\"column\"] p{font-size:12px!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}@media(max-width:640px){.main .block-container{max-width:100vw!important;padding:4px!important}div[data-testid=\"stHorizontalBlock\"]{flex-wrap:nowrap!important;overflow-x:auto!important;gap:2px!important}div[data-testid=\"column\"]{flex:0 0 auto!important;padding:0!important}.stButton>button{height:30px!important;min-width:22px!important;padding:0!important}.stButton>button p{font-size:10px!important}div[data-testid=\"column\"] p{font-size:10px!important}}</style>", unsafe_allow_html=True)
    ...
    st.markdown("<div style='text-align:center;font-size:12px;color:#aaa;margin:6px 0 16px 0'>点击卡片展开分析 · 每次只展开一个</div>", unsafe_allow_html=True)
