...
if st.session_state.step == "welcome":
    ...
    st.markdown("<style>.stButton>button{height:320px!important;padding:30px 10px!important}.stButton>button p{font-size:14px!important;line-height:1.4!important;text-align:center!important;white-space:pre-wrap!important}.stButton>button{max-width:170px!important;margin:0 auto!important}@media(max-width:640px){div[data-testid=\"stHorizontalBlock\"]{flex-wrap:nowrap!important;gap:4px!important}div[data-testid=\"column\"]{min-width:0!important;flex:1 1 50%!important}.stButton>button{height:240px!important;max-width:130px!important;padding:14px 4px!important}.stButton>button p{font-size:11px!important}}</style>", unsafe_allow_html=True)
    s = st.session_state
    ...
    st.markdown("<style>.stButton>button{height:50px!important;padding:2px 6px!important;min-width:36px!important}.stButton>button p{font-size:12px!important;text-align:center!important}div[data-testid=\"column\"]{min-width:0!important;overflow:visible!important}div[data-testid=\"column\"] p{font-size:12px!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}@media(max-width:640px){div[data-testid=\"stHorizontalBlock\"]{flex-wrap:nowrap!important;gap:2px!important}.stButton>button{height:36px!important;min-width:24px!important;padding:0 2px!important}.stButton>button p{font-size:10px!important}div[data-testid=\"column\"] p{font-size:11px!important}}</style>", unsafe_allow_html=True)
